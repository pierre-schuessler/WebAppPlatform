# Registry
In-process app and responsibility management for JavaScript. Add one script tag — autostart handles the rest.
```html
...
- **Responsibility** — a named responsibility owned by one *authority* app. Others call it or monitor it.
...
| Method | Description |
|---|---|
| `responsibility_create(name, app, handler)` | Declare a responsibility owned by `app` |
